...
//   static_assert(plz::circbuff::circular_buffer_pointer<std::array<int, 10>*> == false);
//   static_assert(plz::circbuff::circular_buffer_pointer<std::array<int, 16>*> == true);
//   static_assert(plz::circbuff::circular_buffer_pointer<std::array<int, 0>*> == true);
//   static_assert(plz::circbuff::circular_buffer_pointer<std::array<int, 4>*> == true);
//   static_assert(
//     plz::circbuff::circular_buffer_pointer<std::array<int, size_t(1 << 14)>*> == true);
// }
...
// template <>
// struct plz::circbuff::array_traits<my_array>
// {
...
//   static_assert(plz::circbuff::array_traits<my_array>::capacity == 16);
//   static_assert(std::is_same_v<plz::circbuff::array_traits<my_array>::value_type,
//   int>); static_assert(plz::circbuff::circular_buffer_pointer<decltype(&array)>);
